...
function editRow() {
    ...
    // alert(index)
    var emp = RegList[index];
    document.getElementById('EID').value=emp.getId();
    document.getElementById('EName').value=emp.getName();
    document.getElementById('EEmail').value=emp.getEmail();
    document.getElementById('ECity').value=emp.getCity();
    document.getElementById('EAddress').value=emp.getAddress();
    document.getElementById('EDate').value=emp.getDob().toISOString().substr(0,10);
